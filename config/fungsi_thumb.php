...
function UploadImage($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../images_produk_thumb/";
  $vdir_upload2 = "../../../images_produk_large/";
...
function UploadProfil($fupload_name){
  ...
  unlink("../../../foto_berita/".$fupload_name);
  //Hapus gambar di memori komputer
  imagedestroy($im_src);
  imagedestroy($im);
  */
...
function UploadPengiriman($fupload_name){
  $vdir_upload = "../../../images_pengiriman/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $tipe_file   = $_FILES['fupload']['type'];
...
function UploadRekening($fupload_name){
  $vdir_upload = "../../../images_rekening/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $tipe_file   = $_FILES['fupload']['type'];
