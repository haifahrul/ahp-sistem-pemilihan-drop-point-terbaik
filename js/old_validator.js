...
var validator = (function($){
    ...
    tests = {
        ...
        text : function(a, skip){
			...
			if( lengthRange[0] ){
                var charss = a.split('');
                // iterrate on all the words
                var charLength = function(len){
                    for( var c = charss.length; c--; )
                        if( charss[c].length < len )
                            return false;
                    return true;
                };

                if( charss.length < lengthRange[0] || !charLength(lengthRange[0]) ){
    ...
    */
    ...
    function testByType(type, value){
        ...
        if( !type || type == 'password' || type == 'tel' || type == 'search' || type == 'file' || type == 'number' )
            type = 'text';
