...
if ($stat == "tambah") {
    ...
    $hdata = querydb("SELECT id_kriteria, kriteria, keterangan FROM ahp_kriteria WHERE id_kriteria='$id'");
...
if (@$_POST['stat_simpan']) {
    ...
    if ($stat == "tambah") {
        ...
        if ($d_cek[0] == 0) {
            querydb("INSERT INTO ahp_kriteria(kriteria, keterangan)
        ...
        echo $kriteria;
        if ($d_cek[0] == 0) {
            querydb("UPDATE ahp_kriteria SET kriteria='$kriteria', keterangan='$keterangan' WHERE id_kriteria='$id'");
        ...
        <section class='form'>
            <form action="?h=kriteria-input&stat=<?php echo $stat; ?>" method="post" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 validate">
                        <textarea class="form-control" required name="keterangan" rows="5"><?php echo!empty($data['keterangan']) ? $data['keterangan'] : null ?></textarea>
                    </div>
                </div>
