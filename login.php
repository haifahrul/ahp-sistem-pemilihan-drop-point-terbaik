...
if (@$_POST['btn_login']) {
    ...
    <?php } else {
        ...
        ?>
        <script language="JavaScript"> alert("Username atau Password yang Anda masukkan salah/tidak cocok.");</script>
        <?php
    }
}
...
<html lang="en">
    ...
    <head>
        <title>SPK Drop Point Terbaik J&T</title>
                            ...
                            <form class="md-float-material" method="post">
                                ...
                                <div class="auth-box">
                                    <div class="row m-b-20">
                                        <div class="col-md-12">
                                            <h3 class="text-left txt-primary">Silahkan Masuk</h3>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="username"  id="email" placeholder="Nama Pengguna">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" value="Login" name="btn_login">Sign in</button>
                                        </div>
                                    </div>
                                    <hr/>
                                    <!--                                <div class="row">
